...
public abstract class Page {
  ...
  protected boolean isElementPresent(By by) {
    ...
    public void getElementByXpath(String xpth) {
        new WebDriverWait(driver, 25).until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpth)));
        driver.findElement(By.linkText(xpth));
    }
